...
// ===== İDARİ KADRO MODAL SİSTEMİ =====

// Üye verileri
const memberData = {
    'berk-aktas': {
        name: 'Berk Aktaş',
        position: 'İK Sorumlusu',
        department: 'Uzay Mühendisliği - 4. Sınıf',
        photo: 'https://www.neciparda.com/static/media/ben2.55a838db0b09c918d372.jpg',
        about: 'Öğrenci alımları ve eğitim programları koordinatörü olarak görev yapıyor. İnsan kaynakları yönetimi konularında uzman.',
        experience: '3 yıllık İK deneyimi ile kulüp üyelerinin gelişimini destekliyor. Öğrenci mentorluk programları organize ediyor.',
        responsibilities: [
            'Yeni üye alımları ve değerlendirme süreçleri',
            'Eğitim programları koordinasyonu',
            'Üye performans değerlendirmeleri',
            'Mentorluk programı yönetimi',
            'İK politikaları geliştirme'
        ],
        email: 'berk.aktas@uask.edu.tr',
        phone: '+90 555 123 4567'
    },
    'selin-arslan': {
        name: 'Selin Arslan',
        position: 'Eğitim Koordinatörü',
        department: 'Havacılık Mühendisliği - 3. Sınıf',
        photo: 'https://www.neciparda.com/static/media/ben2.55a838db0b09c918d372.jpg',
        about: 'Teknik eğitimler ve workshop organizasyonu konularında uzman. Mentorluk programı yöneticisi olarak görev yapıyor.',
        experience: '2 yıllık eğitim koordinasyonu deneyimi ile üyelerin teknik gelişimini destekliyor.',
        responsibilities: [
            'Teknik eğitim programları düzenleme',
            'Workshop ve seminer organizasyonu',
            'Mentorluk programı yönetimi',
            'Eğitim materyalleri hazırlama',
            'Üye gelişim takibi'
        ],
        email: 'selin.arslan@uask.edu.tr',
        phone: '+90 555 234 5678'
    },
    'oguz-yildiz': {
        name: 'Oğuz Yıldız',
        position: 'Etkinlik Sorumlusu',
        department: 'Uzay Mühendisliği - 2. Sınıf',
        photo: 'https://www.neciparda.com/static/media/ben2.55a838db0b09c918d372.jpg',
        about: 'Sosyal etkinlikler ve takım ruhu geliştirme aktiviteleri organizatörü. Kulüp içi sosyal bağları güçlendiriyor.',
        experience: '1 yıllık etkinlik organizasyonu deneyimi ile başarılı sosyal etkinlikler düzenliyor.',
        responsibilities: [
            'Sosyal etkinlikler organize etme',
            'Takım ruhu geliştirme aktiviteleri',
            'Kulüp içi sosyal bağları güçlendirme',
            'Etkinlik bütçesi yönetimi',
            'Dış organizasyonlarla işbirliği'
        ],
        email: 'oguz.yildiz@uask.edu.tr',
    ...
    'ahmet-yilmaz': {
        ...
        department: 'Havacılık Mühendisliği - 3. Sınıf',
        photo: 'https://www.neciparda.com/static/media/ben2.55a838db0b09c918d372.jpg',
        about: 'Teknik ekipman yönetimi ve laboratuvar koordinasyonu konularında uzman. 2 yıllık teknik deneyimi var.',
        experience: 'Teknik ekipmanların bakımı, güvenliği ve kullanımı konularında deneyimli.',
        responsibilities: [
            'Teknik ekipman yönetimi',
            'Laboratuvar koordinasyonu',
            'Ekipman bakım ve onarımı',
            'Güvenlik protokolleri uygulama',
            'Teknik eğitimler düzenleme'
        ],
        email: 'ahmet.yilmaz@uask.edu.tr',
    ...
    'fatma-demir': {
        ...
        department: 'Uzay Mühendisliği - 2. Sınıf',
        photo: 'https://www.neciparda.com/static/media/ben2.55a838db0b09c918d372.jpg',
        about: 'Dış iletişim ve medya ilişkileri konularında uzman. Sosyal medya ve web yönetimi yapıyor.',
        experience: '1 yıllık iletişim ve medya deneyimi ile kulübün görünürlüğünü artırıyor.',
        responsibilities: [
            'Dış iletişim yönetimi',
            'Sosyal medya hesapları yönetimi',
            'Web sitesi içerik yönetimi',
            'Medya ilişkileri',
            'Basın bültenleri hazırlama'
        ],
        email: 'fatma.demir@uask.edu.tr',
...
function initMemberModal() {
    console.log('İdari Kadro modal sistemi başlatılıyor...');

    // Tıklanabilir üye kartlarına event listener ekle
    const clickableMembers = document.querySelectorAll('.clickable-member');
    clickableMembers.forEach(member => {
        member.addEventListener('click', (e) => {
            e.preventDefault();
            const memberId = member.getAttribute('data-member');
            console.log('Üye tıklandı:', memberId);
            openMemberModal(memberId);
        });

        // Hover efekti için GSAP animasyonu
    ...
    console.log('İdari Kadro modal sistemi aktif');
}

// Modal sistemini başlat
document.addEventListener('DOMContentLoaded', () => {
    // Diğer init fonksiyonlarından sonra çalıştır
    setTimeout(() => {
        initMemberModal();
    }, 1000);
});